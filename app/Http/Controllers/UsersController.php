...
class UsersController extends BaseController {
	...
	{
		$this->data["pTitle"] = Auth::user()->full_name;
		$this->data["user_info"] = DB::table("users")->get();
		//$indexs = user::orderBy('created_at','desc')->paginate(5);
       	return View::make('ins/settings')->with($this->data);
	}
    ...
    public function deleteUser()
    {
    	...
    	function getData()
    	{
    		...
    		if (count($data)>0) {
    			return view('ins/settings')->with('data',$data);
    		}
    		else
    		{
    			return view('ins/settings');
    		}
    	}
